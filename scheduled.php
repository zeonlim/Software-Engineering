...
<title>ijobassistant - Scheduled</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="scheduled.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg> Scheduled</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="/cms/entry/admin?type=interview">Upcoming</a></li>
		</ul>
		...
		<thead>
			<tr>
				<th id="yw0_c0">Job Title</th><th>Interview Date Time</th><th>Interview Venue</th><th>Applicant / Candidate</th><th>Applied Date</th></tr>
		</thead>
		<tbody>
