...
<div class="container page-content">
    ...
    <section id="plans" class="m-t-20">
				...
				<li class=""><a href="pricingads.php">Featured Ads</a></li>
				<li class=""><a href="pricingcredit.php">Resume Credit</a></li>
			</ul>
            <div class="row">
				<?php
...
echo "				
				...
				<a class='btn btn-lg btn-block btn-bronze' href='/subscription/default/subscribe?identity=jobs&amp;packageId=1&amp;ownedBy=237968&amp;company=237968&amp;cancelUrl=%2Fsubscription%2Fdefault%2Fcreate' data-toggle='modal'>BUY NOW!</a>
				</div>							
			</div>
			</div><!-- /item -->
