               ...
               <div class="col-md-12">
                  ...
                  <section id="plans" class="m-t-20">
                     <ul class="nav nav nav-tabs m-b-20">
                        ...
                        <li class="active"><a href="valid.php">Extra Valid</a></li>
                     </ul>
                     <div class="row">
                       <?php
require("database.php");
...
";             
               ...
               echo "   
               <li class='list-group-item'><i class='fa fa-check'>$period credit validity</i></li>
               "; 
...
echo "            
            ...
            <a class='btn btn-lg btn-block btn-bronze' href='http://ijobassistant.com/companyDashboard/paypal/paypal/member/paymentAdver.php?packageID=$packageID&type=duration' data-toggle='modal'>BUY NOW!</a>
            </div>                     
         </div>
         </div><!-- /item -->
