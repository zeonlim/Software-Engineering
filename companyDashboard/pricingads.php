               ...
               <div class="col-md-12">
                  ...
                  <section id="plans" class="m-t-20">
                     <ul class="nav nav nav-tabs m-b-20">
                        <li class=""><a href="pricing.php">Job Advertisement</a></li>
                        <li class="active"><a href="pricingads.php">Extra Post</a></li>
...
";             
            if($post>0){
               echo "   
               <li class='list-group-item'><i class='fa fa-check'></i>$post job advertisement </li>
               "; 
            }
            if($adver >0){
               echo "   
...
echo "            
            ...
            <a class='btn btn-lg btn-block btn-bronze' href='http://ijobassistant.com/companyDashboard/paypal/paypal/member/paymentAdver.php?packageID=$packageID&type=post' data-toggle='modal'>BUY NOW!</a>
            </div>                     
         </div>
         </div><!-- /item -->
