               ...
               <div class="col-md-12">
                  ...
                  <section id="plans" class="m-t-20">
                     <ul class="nav nav nav-tabs m-b-20">
                        ...
                        <li class="active"><a href="pricingcredit.php">Extra Adword</a></li>
...
";             
            ...
            if($adver >0){
               echo "   
               <li class='list-group-item'><i class='fa fa-check'></i>$adver Adwords</li>
               "; 
            }
...
echo "            
            ...
            <a class='btn btn-lg btn-block btn-bronze' href='http://ijobassistant.com/companyDashboard/paypal/paypal/member/paymentAdver.php?packageID=$packageID&type=adver' data-toggle='modal'>BUY NOW!</a>
            </div>                     
         </div>
         </div><!-- /item -->
