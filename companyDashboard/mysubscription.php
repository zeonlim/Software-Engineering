...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<a class="pull-right btn btn-primary" href="pricing.html">Purchase</a>

		<div id="yw3">
		<ul id="yw4" class="nav nav-tabs">
			<li class="active">
				<a href="mysubscription.html">Featured</a></li>
			<li>
				<a href="mysubscriptionjobs.html">Jobs</a></li>
			<li>
				<a href="mysubscriptionresume.html">Retrieve Resume</a></li>
		</ul>
		<div class="tab-content"><div id="yw3_tab_1" class="tab-pane fade active in"><div id="yw1" class="grid-view">
		...
		</div></div><div id="yw3_tab_2" class="tab-pane fade"></div><div id="yw3_tab_3" class="tab-pane fade"></div></div></div></div>
