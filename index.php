...
$loginUsername=$_SESSION['userName'];
  ...
  $percentIntern= round((($totalIntern/$totalUser)*100))."%";
   ...
   /*<input type=text value=<?= $totalIntern?>>*/
...
<input type="hidden" name="june" id="june" value=<?= $june?>>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#top"><span>iJOBAssistant </span>Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="package.php"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Package</a></li>
		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-orange" data-percent="<?=$percentIntern?>" ><span class="percent"><?=$percentIntern?></span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Companys</h4>
						<div class="easypiechart" id="easypiechart-teal" data-percent="<?=$percentCompany?>" ><span class="percent"><?=$percentCompany?></span>
						</div>
					</div>
				</div>
			</div>
